  ...
  return (
    <View style={[s.container, { backgroundColor: colors.bg }]}>
      ...
      {voiceModeActive && activeChat && (
        <VoiceMode chatId={activeChat.id} modelId={activeChat.model || DEFAULT_MODEL_ID} onClose={() => { openingVoiceModeRef.current = false; setVoiceModeActive(false); loadMessages(activeChat.id); }} />
      )}
    </View>
  );
}
